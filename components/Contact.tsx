        ...
        <div className="flex flex-col">
          <div className="flex flex-row">
            ...
            <div className="absolute flex flex-row justify-start float-left mt-20 h-[750px] bg-blue-300">
              <img className="h-[150px] w-[150px] px-4 py-2" src={temp.src}/>
              <img className="h-[150px] w-[150px] py-2 px-4"  src={temp.src}/>
              <img className="h-[150px] w-[150px] py-2 px-4"  src={temp.src}/>
              <img className="h-[150px] w-[150px] py-2"  src={temp.src}/>
            </div>
        </div>
      </div>
    </Carousel>
