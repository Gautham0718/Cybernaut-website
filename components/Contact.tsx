  ...
  return (
    ...
    >
      ...
      <div className="h-full m-6">
        ...
        <div className=" bg-blue-400 flex flex-row gap-x-20">
        ...
        <div className="flex flex-row ">
          <h4 className="text-6x1 flex-row">Instagram @cybernaut_official</h4>
          <div className="flex flex-row pl-3 mt-3 w-[50%] align-middle h-1 bg-gradient-to-r from-red-300 via-red-500 to-red-300"></div>
        </div>
        <div className="flex flex-row bg-red-400 gap-x-20">
            <div><img src={temp.src}/></div>
            <div><img src={temp.src}/></div>
            <div><img src={temp.src}/></div>
            <div><img src={temp.src}/></div>
