...
const career = () => {
    return(
        ...
        <div className="flex lg:h-[90%] w-full">
            <img src={bg.src} />
        </div>
            ...
            <div className="flex flex-row justify-between">
                <div>
                    <div className="flex flex-row">
                        <h1 className=" font-bold text-6xl">Ready to be one of us?</h1>
                        <div className="flex w-[10%] h-1 bg-gradient-to-r from-cyan-400 via-cyan-500 to-blue-300"></div>
                    </div>
                    <p className=" gap-y-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
