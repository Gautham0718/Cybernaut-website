        ...
        <div className="lg:h-[70%] bg-gray-200 ml-6 m-6">
          <div className="flex flex-row align-middle items-center ml-12">
            ...
            <div className=" border-solid border border-gray-400 rounded-full h-96 w-96 origin-top-left mt-16">
              ...
              <BellIcon className="absolute w-10 h-10 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-[400px] translate-y-20"/>
              <BookmarkIcon className="w-10 h-10 absolute border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-[400px] translate-y-64"/>
              <BriefcaseIcon className="absolute w-10 h-10 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-44 translate-y-[400px] "/>
            ...
            <div className=" absolute m-32 origin-center justify-center align-middle items-center border border-solid border-white bg-white  h-50 w-50 rounded-full">
