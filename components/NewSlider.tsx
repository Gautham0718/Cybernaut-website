    ...
    <div className="flex flex-col items-center gap-y-2">
      ...
      >
        ...
        <div className="lg:h-[70%] bg-gray-200 ml-6 m-6">
          <div className="flex flex-row align-middle items-center ml-12 mt-20">

            
            <div className="absolute border-solid border border-gray-400  h-96 w-96 rounded-[500px]  mt-16">
