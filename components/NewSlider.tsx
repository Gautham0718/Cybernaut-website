        ...
        <div className="lg:h-[70%] bg-gray-200 ml-6 m-6">
          <div className="flex flex-row align-middle items-center ml-12">
            ...
            <div className=" border-solid border border-gray-400 rounded-full h-96 w-96 origin-top-left mt-16">
              ...
              <AtSymbolIcon className="absolute w-10 h-10 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-40"/>
              <BellIcon className="absolute w-10 h-10 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-80 translate-y-20"/>
              <BookmarkIcon className="w-10 h-10 absolute border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-80 translate-y-64"/>
              <BriefcaseIcon className="absolute w-10 h-10 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-x-40 translate-y-96 "/>
            ...
            <div className=" absolute m-24 origin-center justify-center align-middle items-center border border-solid border-white bg-white rounded-full h-40 w-40">
