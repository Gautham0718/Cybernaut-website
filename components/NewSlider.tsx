        ...
        <div className="lg:h-[70%] bg-gray-200  m-10">
          <div className="flex flex-row align-middle items-center ml-20">
            ...
            <div className="absolute border-solid border border-gray-400  h-96 w-96 rounded-[500px] origin-top-left mt-[10%]">
              <AcademicCapIcon href="#" onClick={figma} className="absolute shadow-blue-200 ease-linear duration-200 hover:bg-blue-400 hover:text-white cursor-pointer py-0 w-12 h-12 border border-solid border-gray-400 rounded-full bg-white text-blue-400 translate-y-20"/>
