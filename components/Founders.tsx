  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="bg-gray-200 flex flex-col  items-center justify-between gap-y-4 w-[90%] md:w-[40%]">
      ...
      <div className="flex flex-col items-center justify-center lg:h-[70%] ">
        ...
        <div className="bg-gray-200  flex flex-col gap-y-4 w-[90%] md:w-[40%] items-center justify-between">
        <img className="h-full" src={IMG.src} />
