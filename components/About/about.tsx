...
const about = () => {
    return(
        ...
        <div className=" bg-gray-300 h-20 justify-center content-center align-middle items-center">
            <div className=" text-2xl align-middle justify-center items-center text-center object-center pt-5">
        ...
        <div className="flex flex-row pt-10">
            <div className="flex items-center">
                <img className=" relative ml-20 flex justify-center object-center align-middle md:w-80" src = {HomeLogo.src}/>
            </div>
