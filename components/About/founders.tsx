        ...
        <div className="m-8">
            ...
            <div className="flex flex-row gap-x-10">
                <div className="flex flex-col">
                    <img src={CEO.src}/>
                    <h2 className="text-[12px] font-bold">JAYASURYA G</h2>
                    <div className=" text-gray-400 font-semibold">Chief Executive Officer</div>
                    <div className="w-16 h-1 pt-2 bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200"></div>
                    ...
                    <div className="flex flex-row pr-4 text-2xl text-blue-400">
                        <CameraIcon/>
                        <CameraIcon/>
                        <CameraIcon/>
                    </div>
                ...
                <div className="flex flex-col">
                    <img src={CEO.src}/>
                    <h2 className="text-[12px] font-bold">B. MANISH KUMAR</h2>
                ...
                <div className="flex flex-col">
                    <img src={CEO.src}/>
                    <h2 className="text-[12px] font-bold">KEERTHANA R</h2>
